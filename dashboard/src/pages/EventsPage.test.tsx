...
const paginatorFixture = {
  ...
  from: 1,
  last_page: 3,
  first_page_url: '/ingest/stats/events?page=1',
  last_page_url: '/ingest/stats/events?page=3',
  next_page_url: '/ingest/stats/events?site=example&page=2',
  prev_page_url: null,
  path: '/ingest/stats/events',
  per_page: 20,
  to: 2,
  total: 42,
  links: [],
